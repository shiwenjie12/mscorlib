...
namespace Microsoft.Win32 {
    ...
    internal static class Win32Native {
        ...
        /// </summary>
        /// <param name="hFile">一个文件指定句柄。</param>
        ...
        /// </summary>
        /// <param name="handle">文件的句柄</param>
        /// <param name="bytes">用于保存读入数据的一个缓冲区</param>
        /// <param name="numBytesToRead">要读入的字节数</param>
        /// <param name="numBytesRead_mustBeZero">指向实际读取字节数的指针</param>
        /// <param name="overlapped">如文件打开时指定了FILE_FLAG_OVERLAPPED，那么必须，用这个参数引用一个特殊的结构。</param>
        ...
        /// <param name="highSize">指向高阶双字的文件大小的指针，此参数可以为NULL</param>
        /// <returns>
        ...
        /// <summary>
        /// 在windows中，文件可用共享模式打开——在这种情况下，多个进程可同时访问该文件。
        /// </summary>
        /// <param name="handle">欲锁定文件的句柄</param>
        /// <param name="offsetLow">指定欲锁定区域起始处的低32位地址s</param>
        /// <param name="offsetHigh">指定欲锁定区域起始处的高32位地址</param>
        /// <param name="countLow">锁定区域包含字符数量的低32位值</param>
        /// <param name="countHigh">锁定区域包含字符数量的高32位值</param>
        /// <returns></returns>
        [DllImport(KERNEL32, SetLastError=true)]
        [ResourceExposure(ResourceScope.None)]
        ...
        /// 解除对一个文件的锁定
        /// </summary>
        /// <param name="handle">要解锁的文件的句柄</param>
        /// <param name="offsetLow">要解锁文件区域起始位置的低32位地址</param>
        /// <param name="offsetHigh">要解锁文件区域起始位置的高32位地址</param>
        /// <param name="countLow">锁定区域中字符数量的低32位值</param>
        /// <param name="countHigh">锁定区域中字符数量的高32位值</param>
        /// <returns></returns>
        [DllImport(KERNEL32, SetLastError=true)]
        [ResourceExposure(ResourceScope.None)]
