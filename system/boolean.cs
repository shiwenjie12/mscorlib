...
#endif
    {
      ...
      **Exceptions: None.
      ...
      public bool Equals(Boolean obj)
      {
        ...
        /// 清空空格和Null字符
        /// </summary>
        /// <param name="value">要清空的字符串</param>
        /// <returns>清空以后的字符串</returns>
        private static String TrimWhiteSpaceAndNull(String value) {
            int start = 0;
            int end   = value.Length-1;
            char nullChar = (char) 0x0000;//空字符

            while (start < value.Length) {//获取开始字符不为空索引
            ...
            return value.Substring(start, end - start + 1);//截取字符串
        }       
