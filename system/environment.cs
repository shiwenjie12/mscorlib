...
namespace System {
    ...
    public static class Environment {
        ...
        const int MaxEnvVariableValueLength = 32767;  //最大长度为环境变量名称和值
        ...
        // 系统环境变量存储在注册表中，有大小限制，既独立于正常环境变量和注册表值名称长度，
        // MSDN不详细名称是否仅限于1024年,是否包括环境变量的内容。
