...
namespace System.Threading
{
    ...
    internal sealed class RegisteredWaitHandleSafe : CriticalFinalizerObject
    {
        ...
        ~RegisteredWaitHandleSafe()
        {
            ...
            //
            // During AD-unload, we don抰 finalize live objects until all threads have been 
            // aborted out of the AD.  Since these locked regions are CERs, we won抰 abort them 
