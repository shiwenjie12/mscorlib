...
namespace System.Threading {
    ...
    public static class Monitor 
    {
        ...
        ** Exceptions: ArgumentNullException if object is null.
        ...
        /// <param name="lockTaken">尝试获取锁的结果，通过引用传递。 输入必须为 false。 如果已获取锁，则输出为 true；否则输出为 false。
        /// 即使在尝试获取锁的过程中发生异常，也会设置输出。注意   如果没有发生异常，则此方法的输出始终为 true。</param>
        /// <exception cref="System.ArgumentException:">对 lockTaken 的输入是 true。</exception>
        /// <exception cref="System.ArgumentNullException:">obj 参数为 null。</exception>
