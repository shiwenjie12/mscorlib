...
namespace System.Threading
{
    ...
    public static class Volatile
    {
        ...
        /// <summary>
        /// 从指定的字段读取对象引用。 
        /// 在需要进行此操作的系统上，插入防止处理器重新对内存操作进行排序的内存屏障，
        /// 如下所示：如果读取或写入操作在代码中出现在此方法之后，则处理器无法将其移至此方法之前。
        /// </summary>
        ...
        /// <summary>
        /// 将指定的对象引用写入指定字段。 在需要进行此操作的系统上，插入防止处理器重新对内存操作进行排序的内存屏障，
        /// 如下所示：如果读取或写入操作在代码中出现在此方法之前，则处理器无法将其移至此方法之后。
        /// </summary>
