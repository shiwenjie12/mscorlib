...
{    
    ...
    /// <summary>
    /// 提供了一个方法集，这些方法用于分配非托管内存、复制非托管内存块、
    ...
    return false;
        ...
        /// 返回非托管类型的大小（以字节为单位）。
        /// </summary>
        /// <param name="t">要返回其大小的格式</param>
        /// <returns>非托管代码中指定类型的大小</returns>
        /// <exception cref="System.ArgumentException:">t参数为泛型类型</exception>
        /// <exception cref="System.ArgumentNullException:">t参数为null</exception>
        [ResourceExposure(ResourceScope.None)]
        [Pure]
...
#if !FEATURE_CORECLR // 因为Marshal在CoreCLR是危险的，所以SafeCritical成员可能引发障碍
