...
namespace System.IO {
    ...
    /// <summary>
    /// 初始化 IOException 类的新实例，使其消息字符串设置为空字符串 ("")，其 HRESULT 设置为 COR_E_IO，而其内部异常设置为空引用。
    /// </summary>
    [Serializable]
    ...
    public class IOException : SystemException
    {
        ...
        /// <summary>
        /// 初始化 IOException 类的新实例，使其消息字符串设置为 message，其 HRESULT 设置为 COR_E_IO，而其内部异常设置为 null。
        /// </summary>
