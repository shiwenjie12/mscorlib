...
namespace System.IO {
    ...
    // 
    unsafe internal struct PathHelper {   // 不应该被序列化
        ...
        /// <summary>
        /// 实例化一个PathHelper（通过栈分配）
        /// </summary>
        /// <param name="charArrayPtr"></param>
        ...
        /// 固定保存名字
        /// </summary>
        /// <param name="lenSavedName">保存名字长度</param>
        /// <param name="lastSlash"></param>
        [System.Security.SecurityCritical]
        ...
        /// <summary>
        /// 不依赖与区域性字符串实的开头是否与指定的字符串匹配
        /// </summary>
        /// <param name="compareTo">要比较的字符串</param>
        /// <param name="ignoreCase">是否忽略大小写</param>
        /// <returns>true（如果该实例以 compareTo 开头；否则为 false）。</returns>
        [System.Security.SecurityCritical]
