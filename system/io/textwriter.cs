...
namespace System.IO {
    ...
    public abstract class TextWriter : IDisposable {
        ...
        // the value here.
        // 这是应该初始化Envirment.NewLine,但是为了避免加重不必要的环境，所以我打算在这复制这个值
        /// <summary>
        /// 初始化新的行
        /// </summary>
        ...
        // 可能是null-如果是这样的，可能每次请去线程的CurrentCulture
        ...
        /// <summary>
        /// 释放有System.io.TextWriter对象使用的所有资源
        /// </summary>
        ...
        public virtual String NewLine {
            get { return new String(CoreNewLine); }// 返回字符数组转换为字符串
            set {
                if (value == null) 
        ...
        /// </summary>
        /// <param name="writer">要同步的textwriter</param>
        /// <returns></returns>
        ...
        public static TextWriter Synchronized(TextWriter writer) {
            ...
            if (writer is SyncTextWriter)// 如果writer是同步的textwriter，则返回此textwriter
                return writer;
            
            return new SyncTextWriter(writer);// 构造同步textwriter
        }
        ...
        // 将一个字符写入文本流中，这个默认的方法是空的。
        // 但是后代类可以重写该方法以提供适当的功能。
        /// <summary>
        /// 将字符写入该文本字符串或流。
        /// </summary>
        ...
        /// <summary>
        /// 将Boolean值的文本表示形式写入文本字符串或流
        /// </summary>
        /// <param name="value">要编写的boolean</param>
        ...
        public virtual void Write(Object value) {
            if (value != null) {
                // 判断值是否可以转换为IFormattable，如果可以则使用指定的格式格式化当前实例的值
    ...
    //      }
        ...
        public virtual void WriteLine(String value) {
            ...
            if (value==null) {
                ...
                // 将字符串的写入变为原子性一次写入，先将需要写入的字符串和换行字符转换为一个
                // 字符数组，然后写入到文本字符串或流中
